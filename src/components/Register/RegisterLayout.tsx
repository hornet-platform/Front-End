...
import {Button, Form, Steps, Row, Divider} from "antd";
                        ...
                        items={[
                            {
                                ...
                                status: currentStepIndex === 0 ? "process" : "finish", // Change "done" to "finish"
                                icon: <UserOutlined className={styles.customStepRegisterIcon}/>,
                            },
                            {
                                title: <span
                                    className={currentStepIndex === 1 ? styles.customStepProfile : ''}>Profile</span>,
                                status: currentStepIndex === 1 ? "process" : "wait",
                                icon: <SolutionOutlined
                                    className={currentStepIndex === 1 ? styles.customStepProfileIcon : ''}/>,
                            }
                        ]}
                        style={{
                            marginBottom: 25,
